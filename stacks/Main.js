...
const MainTabNavigator = () => {
    return(
        <Tab.Navigator initialRouteName="Home"  screenOptions={{ tabBarHideOnKeyboard:true, tabBarStyle:{borderTopWidth:0},headerShown:false,tabBarShowLabel:false,tabBarInactiveBackgroundColor:'#2A2A2C',tabBarActiveBackgroundColor:'#2A2A2C', tabBarInactiveTintColor:'white'}}>
